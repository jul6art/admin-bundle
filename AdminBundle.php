...
use Jul6Art\AdminBundle\DependencyInjection\Compiler\GlobalSearchPass;
...
class AdminBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container): void
    {
        ...
        // Le moteur de la recherche d'en-tête, retiré quand Doctrine n'est pas là (même question que
        // l'écran d'apparence, sans l'enjeu de priorité : aucun locator ne le référence).
        $container->addCompilerPass(new GlobalSearchPass());
