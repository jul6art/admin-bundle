...
`admin.enabled` is also exposed as a container parameter.
...
Symfony admin backoffice bundle is open-sourced software licensed under the [MIT license](https://opensource.org/licenses/MIT).
